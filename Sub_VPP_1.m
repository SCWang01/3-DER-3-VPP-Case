function solution_1=Sub_VPP_1(x_2,x_3,eps)
    switching_1=0;
    switching_2=35;
    switching_3=20;
    ...
    obj=x_1*(100*y_2(1)+120*y_3(1))+switching_1*(1-y_1(1));

    %optimization settings
    ops=sdpsettings('solver','gurobi');
    %obj=-switching_1*y_1;
    optimize(F,-obj,ops);  
    solution_1.x_1=double(x_1);
    solution_1.y_1=double(y_1);
    solution_1.y_2=double(y_2);
    solution_1.y_3=double(y_3);
    solution_1.y_1_afflication=[y_1(1),y_2(1),y_3(1)];
end
